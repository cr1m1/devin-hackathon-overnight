...
export async function HealthBanner() {
  ...
  try {
    ...
    if (h.devin === "unconfigured") problems.push("Devin is not configured (DEVIN_API_KEY / DEVIN_ORG_ID).");
    if (h.devin === "error") problems.push("Devin rejected the API key or organization id.");
